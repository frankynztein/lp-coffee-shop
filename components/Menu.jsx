...
const menuItems = [
  ...
  },
  {
    imgSrc: "/assets/menu/coffee-5.png",
    name: "Irish Coffee",
    description: "Coffee with Irish whiskey and creeam",
    price: 6.5,
  },
];
    ...
    <section id="menu" className="pt-12 pb-16 xl:pt-16 xl:pb-36">
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[620px] mx-auto">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Alias rerum magnam culpa dolores pariatur temporibus odit quam totam asperiores quisquam doloremque perferendis, libero excepturi ex unde! Officia molestiae tempora veniam.</p>
        </div>
        {/* Menu and button */}
